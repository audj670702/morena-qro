...
function renderInicioContenidoDestacado() {
  const hayMultimedia = appState.multimedia.length || appState.multimediaCargando;
...
function renderInicioBannerMultimedia() {
  if (appState.multimediaCargando) {
    return `
      <article class="home-feature-card media-feature-card is-loading">
